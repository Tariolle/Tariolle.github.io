...
Recent projects include [Hack the World(s)](https://github.com/Tariolle/hello-worlds), where our team was a finalist at a 24-hour hackathon on JEPAs and world models sponsored by Yann LeCun. Our project applied geometry-aware self-supervised learning to EEG, establishing a strong SIGReg frozen-transfer baseline and finding that SPD-tangent geometry made learned latent structure more visible. Other recent projects include [Opportunistic Target Selection](https://arxiv.org/abs/2605.25663), a lightweight wrapper for query-efficient score-based black-box adversarial attacks accepted at CAp 2026, and [SLS-WM](https://tariolle.github.io/sls-wm/), an independent research project on annealed structured label smoothing for discrete world models.
